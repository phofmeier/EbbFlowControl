...
void subscribe_to_config_channel(esp_mqtt_client_handle_t client)
{
    ...
    esp_mqtt5_client_set_user_property(&config_subscribe_property.user_property, user_property_arr, USE_PROPERTY_ARR_SIZE);
    ...
    esp_mqtt5_client_delete_user_property(config_subscribe_property.user_property);
